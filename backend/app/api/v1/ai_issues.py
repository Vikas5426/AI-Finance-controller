...
def get_ai_issues_report(
    ...
    force_refresh: bool = Query(False, description="Whether to bypass cache and recompute analysis."),
    ...
    Uses batch-level caching to avoid redundant LLM requests.
    """
    org_id = current_user["org_id"]
    report = AIIssuesService.generate_report(org_id=org_id, batch_id=batch_id, force_refresh=force_refresh)
    return report
